...
func TestMsgTransferNFTGetSignBytesMethod(t *testing.T) {
	...
	expected := `{"type":"furymod/nft/MsgTransferNFT","value":{"data":"{\"key1\":\"value1\",\"key2\":\"value2\"}","denom_id":"denom","id":"denom","name":"id1","recipient":"cosmos15ky9du8a2wlstz6fpx3p4mqpjyrm5cgp0ctjdj","sender":"cosmos15ky9du8a2wlstz6fpx3p4mqpjyrm5cgqjwl8sq","uri":"https://google.com/token-1.json","uri_hash":"uriHash"}}`
...
func TestMsgEditNFTGetSignBytesMethod(t *testing.T) {
	...
	expected := `{"type":"furymod/nft/MsgEditNFT","value":{"data":"{\"key1\":\"value1\",\"key2\":\"value2\"}","denom_id":"denom","id":"id1","name":"report","sender":"cosmos15ky9du8a2wlstz6fpx3p4mqpjyrm5cgqjwl8sq","uri":"https://google.com/token-1.json","uri_hash":"uriHash"}}`
	require.Equal(t, expected, string(sortedBytes))
}
...
func TestMsgMintNFTGetSignBytesMethod(t *testing.T) {
	...
	expected := `{"type":"furymod/nft/MsgMintNFT","value":{"data":"{\"key1\":\"value1\",\"key2\":\"value2\"}","denom_id":"denom","id":"id1","name":"report","recipient":"cosmos15ky9du8a2wlstz6fpx3p4mqpjyrm5cgp0ctjdj","sender":"cosmos15ky9du8a2wlstz6fpx3p4mqpjyrm5cgqjwl8sq","uri":"https://google.com/token-1.json","uri_hash":"uriHash"}}`
	require.Equal(t, expected, string(sortedBytes))
}
