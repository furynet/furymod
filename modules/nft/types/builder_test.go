...
func TestClassBuilder_BuildMetadata(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want:    `{"furymod:creator":{"value":"f8a9eee6bce5bc043e5feec2baef355f87dbfcdf"},"furymod:description":{"value":"digital cat"},"furymod:mint_restricted":{"value":true},"furymod:name":{"value":"kitty"},"furymod:schema":{"value":"{}"},"furymod:symbol":{"value":"symbol"},"furymod:update_restricted":{"value":true},"furymod:uri_hash":{"value":"uri_hash"}}`,
			wantErr: false,
		},
		{
		...
		},
		{
			...
			want:    `{"furymod:creator":{"value":"f8a9eee6bce5bc043e5feec2baef355f87dbfcdf"},"furymod:description":{"value":"digital cat"},"furymod:mint_restricted":{"value":true},"furymod:name":{"value":"kitty"},"furymod:schema":{"value":"{}"},"furymod:symbol":{"value":"symbol"},"furymod:update_restricted":{"value":true},"furymod:uri_hash":{"value":"uri_hash"},"key1":"value1","key2":"value2"}`,
			wantErr: false,
		},
		{
...
func TestClassBuilder_Build(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "empty classData",
			args: args{
				classData: `{"furymod:creator":{"value":"f8a9eee6bce5bc043e5feec2baef355f87dbfcdf"},"furymod:description":{"value":"digital cat"},"furymod:mint_restricted":{"value":true},"furymod:name":{"value":"kitty"},"furymod:schema":{"value":"{}"},"furymod:symbol":{"value":"symbol"},"furymod:update_restricted":{"value":true},"furymod:uri_hash":{"value":"uri_hash"}}`,
			},
			want:    `{"@type":"/cosmos.nft.v1beta1.Class","id":"cat","name":"kitty","symbol":"symbol","description":"digital cat","uri":"uri","uri_hash":"uri_hash","data":{"@type":"/furymod.nft.DenomMetadata","creator":"cosmos1lz57ae4uuk7qg0jlampt4me4t7rahlxl5pnn3y","schema":"{}","mint_restricted":true,"update_restricted":true,"data":""}}`,
			wantErr: false,
		},
		{
			name: "classData is invalid json string",
			...
			want:    `{"@type":"/cosmos.nft.v1beta1.Class","id":"cat","name":"","symbol":"","description":"","uri":"uri","uri_hash":"","data":{"@type":"/furymod.nft.DenomMetadata","creator":"cosmos1lz57ae4uuk7qg0jlampt4me4t7rahlxl5pnn3y","schema":"","mint_restricted":true,"update_restricted":true,"data":"this is empty class data"}}`,
			wantErr: false,
		},
		{
			name: "classData is valid json string",
			args: args{
				classData: `{"furymod:creator":{"value":"f8a9eee6bce5bc043e5feec2baef355f87dbfcdf"},"furymod:description":{"value":"digital cat"},"furymod:mint_restricted":{"value":true},"furymod:name":{"value":"kitty"},"furymod:schema":{"value":"{}"},"furymod:symbol":{"value":"symbol"},"furymod:update_restricted":{"value":true},"furymod:uri_hash":{"value":"uri_hash"},"key1":"value1","key2":"value2"}`,
			},
			want:    `{"@type":"/cosmos.nft.v1beta1.Class","id":"cat","name":"kitty","symbol":"symbol","description":"digital cat","uri":"uri","uri_hash":"uri_hash","data":{"@type":"/furymod.nft.DenomMetadata","creator":"cosmos1lz57ae4uuk7qg0jlampt4me4t7rahlxl5pnn3y","schema":"{}","mint_restricted":true,"update_restricted":true,"data":"{\"key1\":\"value1\",\"key2\":\"value2\"}"}}`,
			wantErr: false,
		},
	}
	for _, tt := range tests {
